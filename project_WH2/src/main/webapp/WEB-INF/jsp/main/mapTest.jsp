...
<div class="d-flex align-self-center border border-secondary">
    <div class="p-2 align-self-baseline mt-4 border border-secondary" style="width: 12%; ">
    ...
    <div class="p-2 align-self-center" style="width: 35%;">
        <div id="maplist">
            <select class="form-control mb-3" id="sd" name="sd">
                ...
                <c:forEach items="${sidolist}" var="sido"><option id="sido" name="sido" value="${sido.sdCd}">${sido.sdNm}</option></c:forEach>
            </select>
            ...
            <div id="donutchart" style="width: 100%; height: 450px; float: left"></div>
        </div>
        <div id="uploadfile">
